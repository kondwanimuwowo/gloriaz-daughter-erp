            ...
            <div className="space-y-2">
              {materials.slice(0, 5).map((material, index) => (
                <motion.div
                  ...
                  className="bg-white rounded-lg p-3 flex items-center justify-between cursor-pointer hover:shadow-sm transition-shadow border border-transparent hover:border-red-200"
